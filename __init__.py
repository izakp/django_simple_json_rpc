	...
	def validate_parameter(self, parameter, param_validators):
		...
		if param_type == 'unicode':
			...
			if 'length' in param_validators:
				...
				assert len(parameter) is param_validators['length'], 'Invalid parameter'
		...
		if param_type == 'dict':
			...
			if 'allowed_keys' in param_validators:
				...
				for key in parameter.iteritems():
					assert key in param_validators['allowed_keys'], 'Invalid parameter'
